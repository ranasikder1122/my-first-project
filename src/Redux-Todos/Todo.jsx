...
const handleEditTodo =(todo)=>{
  ...
  return (
    <div  className='min-h-screen bg-gray-100 flex flex-col items-center py-10 '>
        ...
        <div className='w-11/12 max-w-4xl space-y-7 '>
            <div className='flex items-center space-x-3 '>
                  <input type="text" value={text} onChange={(e)=>setText(e.target.value)} placeholder='Enter Your Todo List'
                  className='flex-grow px-4 py-4 border rounded-md focus:outline-none'/>
                  <button className='px-p py-2 bg-blue-500 text-white rounded-md hover:bg-blue-600' 
