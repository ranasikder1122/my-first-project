...
<div className='w-23.43 bg-white '>   
               ...
               <div className='hidden xl:contents '>
                  <div className='flex justify-center gap-[143.5px] py-[26px]  pl-[88px] pr-[88px] '>
                  <img className='' src="/src/logotype (1).png" alt="" />
                  <div className='flex shadow-md rounded-sm'>
   <span className=' flex absolute ml-[16px] mt-[15px] text-[#1071FF]'>{<IoIosSearch/>}</span>
   <input className='flex  px-[100px] text-left text-sm  rounded-md placeholder-gray-400'type="text" placeholder='Search by product or SKU'/>
   </div>
   <div className=''>
      <button className=' px-[32px] py-[16px] text-white rounded-3xl text-[16px] 
      font-medium shadow-md bg-[#1071FF]'>Quick Order Form</button>
               ...
               <div className='hidden xl:contents '>
                ...
                <h1 className='flex  font-bold  mt-[40px] text-[28px] '>Our test brands</h1>
   ...
   <input className='flex p-3 px-16 text-left text-sm  rounded-md placeholder-gray-400'type="text" placeholder='Search by product or SKU'/>
     ...
     <span className='absolute bg-[#FF7E27] mt-[8px] xl:text-[24px]'>-30%</span>
     ...
     absolute xl:ml-[261.5px] xl:text-[24px]'>{<CiStar />}</span>
      <img className=' absolute mt-[86.75px] ml-[140.25px] xl:ml-[-180px]'src="/src/compare.png" alt="" />
        <img className='xl:hidden' src="/src/product image.png" alt="" />
       <div className='hidden xl:contents' >
       <img className='' src="/src/product image (2).png" alt="" />
       </div>

        <div className='flex rounded-sm flex-row space-x-1 p-1 shadow-md absolute mt-[-30px] 
        ml-1 xl:text-[24px] xl:p-2 '>
          <img className='text-[10px] ' src="/src/check.png" alt="" />
          <span className='text-[#00893A] text-[10px] xl:text-[14px] '>In stock </span>
        </div>
        {/* rana */}
        <div className='xl:absolute xl:mt-[-20px]'><span className='absolute text-[#1071FF] mt-[-25px] ml-[140px]  xl:ml-[261.5px] text-[24px]' >{<IoShareSocialOutline/>}</span></div>
